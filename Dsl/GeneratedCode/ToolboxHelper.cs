...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	/// </remarks>
	public partial class SGCJLPSPG_WeberToolboxHelper : SGCJLPSPG_WeberToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberToolboxHelper.
		/// </summary>
		public SGCJLPSPG_WeberToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class SGCJLPSPG_WeberToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify SGCJLPSPG_Weber toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "SGCJLPSPG_Weber.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberToolboxHelperBase.
		/// </summary>
		protected SGCJLPSPG_WeberToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("SGCJLPSPG_WeberToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Laigio.SGCJLPSPG_Weber.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Laigio.SGCJLPSPG_Weber.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("SGCJLPSPG_WeberToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Laigio.SGCJLPSPG_Weber.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Laigio.SGCJLPSPG_Weber.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Laigio.SGCJLPSPG_Weber.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel));
