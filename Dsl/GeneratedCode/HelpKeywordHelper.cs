...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	/// </remarks>
	public partial class SGCJLPSPG_WeberHelpKeywordHelper : SGCJLPSPG_WeberHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberHelpKeywordHelper.
		/// </summary>
		protected SGCJLPSPG_WeberHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the SGCJLPSPG_WeberHelpKeywordHelper.
		/// </summary>
		public static SGCJLPSPG_WeberHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class SGCJLPSPG_WeberHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberHelpKeywordHelperBase.
		/// </summary>
		protected SGCJLPSPG_WeberHelpKeywordHelperBase()
			: base() { }
