...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Laigio.SGCJLPSPG_Weber.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Laigio.SGCJLPSPG_Weber.ExampleElement)
				{
					if (candidateTarget is global::Laigio.SGCJLPSPG_Weber.ExampleElement)
					{
						global::Laigio.SGCJLPSPG_Weber.ExampleElement sourceExampleElement = (global::Laigio.SGCJLPSPG_Weber.ExampleElement)candidateSource;
						global::Laigio.SGCJLPSPG_Weber.ExampleElement targetExampleElement = (global::Laigio.SGCJLPSPG_Weber.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::Laigio.SGCJLPSPG_Weber.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Laigio.SGCJLPSPG_Weber.ExampleElement)
				{
					if (target is global::Laigio.SGCJLPSPG_Weber.ExampleElement)
					{
						global::Laigio.SGCJLPSPG_Weber.ExampleElement sourceAccepted = (global::Laigio.SGCJLPSPG_Weber.ExampleElement)source;
						global::Laigio.SGCJLPSPG_Weber.ExampleElement targetAccepted = (global::Laigio.SGCJLPSPG_Weber.ExampleElement)target;
						DslModeling::ElementLink result = new global::Laigio.SGCJLPSPG_Weber.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
