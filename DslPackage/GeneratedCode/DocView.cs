...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	/// </summary>
	internal partial class SGCJLPSPG_WeberDocView : SGCJLPSPG_WeberDocViewBase
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberDocView.
		/// </summary>
		public SGCJLPSPG_WeberDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class SGCJLPSPG_WeberDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberDocView.
		/// </summary>
		protected SGCJLPSPG_WeberDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			SGCJLPSPG_WeberDocDataBase docData = this.DocData as SGCJLPSPG_WeberDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for SGCJLPSPG_WeberDocViewBase should be an SGCJLPSPG_WeberDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.SGCJLPSPG_WeberDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
