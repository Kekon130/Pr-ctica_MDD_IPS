...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	/// </summary>
	internal partial class SGCJLPSPG_WeberDocData : SGCJLPSPG_WeberDocDataBase
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberDocData.
		/// </summary>
		public SGCJLPSPG_WeberDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a SGCJLPSPG_Weber document in memory.
	/// </summary>
	internal abstract partial class SGCJLPSPG_WeberDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberDocDataBase.
		/// </summary>
		protected SGCJLPSPG_WeberDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Laigio.SGCJLPSPG_Weber.ExampleModel modelRoot = null;
			...
			global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Laigio.SGCJLPSPG_Weber.ExampleModel modelRoot = (global::Laigio.SGCJLPSPG_Weber.ExampleModel)this.RootElement;
			...
			{
				global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDiagram diagram = diagrams[0] as global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Laigio.SGCJLPSPG_Weber.ExampleModel modelRoot = this.RootElement as global::Laigio.SGCJLPSPG_Weber.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Laigio.SGCJLPSPG_Weber.SGCJLPSPG_WeberSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
