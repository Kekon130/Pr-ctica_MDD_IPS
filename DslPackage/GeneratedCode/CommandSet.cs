...
namespace Laigio.SGCJLPSPG_Weber
{
	...
	/// </summary>
	internal partial class SGCJLPSPG_WeberCommandSet : SGCJLPSPG_WeberCommandSetBase
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberCommandSet.
		/// </summary>
		public SGCJLPSPG_WeberCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class SGCJLPSPG_WeberCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberCommandSetBase.
		/// </summary>
		protected SGCJLPSPG_WeberCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewSGCJLPSPG_WeberExplorerCommand,
				typeof(SGCJLPSPG_WeberEditorFactory).GUID);
		...
		{
			SGCJLPSPG_WeberExplorerToolWindow explorer = this.SGCJLPSPG_WeberExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected SGCJLPSPG_WeberDocData CurrentSGCJLPSPG_WeberDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as SGCJLPSPG_WeberDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected SGCJLPSPG_WeberDocView CurrentSGCJLPSPG_WeberDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as SGCJLPSPG_WeberDocView;
			}
		}
		...
		/// </summary>
		protected SGCJLPSPG_WeberExplorerToolWindow SGCJLPSPG_WeberExplorerToolWindow
		{
			get
			{
				SGCJLPSPG_WeberExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(SGCJLPSPG_WeberExplorerToolWindow), true) as SGCJLPSPG_WeberExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				SGCJLPSPG_WeberExplorerToolWindow explorerWindow = this.SGCJLPSPG_WeberExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class SGCJLPSPG_WeberClipboardCommandSet : SGCJLPSPG_WeberClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberClipboardCommandSet.
		/// </summary>
		public SGCJLPSPG_WeberClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class SGCJLPSPG_WeberClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new SGCJLPSPG_WeberClipboardCommandSetBase.
		/// </summary>
		protected SGCJLPSPG_WeberClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
